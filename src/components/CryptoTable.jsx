...
export function CryptoTable({ locale, currency, coins, sortConfig, setSortConfig, onSelectCoin, favorites, toggleFavorite }) {
  ...
  return (
    <section className="panel table-panel">
      ...
      {!coins.length ? <p className="empty-message">{t(locale, 'noResults')}</p> : null}
    </section>
  );
}
